...
import { TbBuildingSkyscraper, TbCurrencyNaira } from "react-icons/tb";
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mt-16 mb-10">
            ...
            <p className="text-gray-600 text-base sm:text-lg max-w-3xl mx-auto leading-relaxed">
              Clear explanations of the 2026 tax reforms, written in plain
              language for individuals and businesses in Nigeria.
            </p>
          </div>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-200">
                ...
                <div className="space-y-4">
                  <h4 className="text-gray-700 font-normal leading-relaxed">
                    Nigeria's tax system has been historically complicated, with
                    multiple agencies and overlapping regulations. This created
                    confusion for taxpayers about what taxes applied to them and
                    how much they should pay.
                  </h4>

                  <div className="bg-gray-50 rounded-lg p-4 border-l-4 border-primary">
                    <h4 className="text-gray-700 font-normal leading-relaxed">
                      The 2026 reforms were designed to create a simpler,
                      fairer, and more transparent tax system that encourages
                      compliance while expanding the tax base.
                    </h4>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-xl p-6 border border-gray-200">
                  ...
                  <div className="space-y-3">
                    <p className="text-sm text-gray-700">
                      Annual income below{" "}
                      <span className="font-bold text-primary">₦800,000</span>{" "}
                      is exempt from personal income tax. Income above this
                      amount follows progressive tax bands.
                    </p>
                ...
                <div className="bg-white rounded-xl p-6 border border-gray-200">
                  ...
                  <div className="space-y-3">
                    <p className="text-sm text-gray-700">
                      <span className="font-bold text-primary">20%</span> of
                      annual rent is deductible, with a maximum limit of
                      ₦500,000 per year.
                    </p>
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-200">
                ...
                <div className="space-y-4">
                  <div className="border border-gray-200 rounded-lg p-4">
                    ...
                    <p className="text-sm text-gray-700">
                      Annual turnover below ₦100 million exempt from Corporate
                      Income Tax, VAT, and development levy.
                    </p>
                  </div>
                  ...
                  <div className="border border-gray-200 rounded-lg p-4">
                    ...
                    <p className="text-sm text-gray-700">
                      Minimum 15% effective tax rate with anti-profit shifting
                      measures.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    ...
                    <p className="text-sm text-gray-700">
                      Crypto and digital asset profits are taxable upon
                      realization. Holding assets does not trigger tax.
                    </p>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-sm text-gray-700">
                      Capital gains on property sales are taxable. Personal
                      residences and small personal items are exempt.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-200">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    },
                    {
                      ...
                      icon: <FaBusinessTime className="text-primary" />,
                    },
                    {
                ...
                <div className="mt-6 pt-6 border-t border-gray-100">
                  <p className="text-sm text-gray-600">
                    Impact varies by group. Some benefit from new exemptions,
                    others face clearer obligations.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-200 border-primary/30">
                ...
                <div className="space-y-4">
                  <h4 className="text-sm text-gray-700">
                    For official tax filing, disputes, penalties, and legal
                    interpretations, contact the Nigeria Revenue Service.
                  </h4>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <h4 className=" font-normal text-gray-600">
                      Always verify information with the official NRS website
